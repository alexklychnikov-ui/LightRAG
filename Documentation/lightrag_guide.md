...
- 2026-06-10 — Промпт: актуализировать phone-конфиги NekoBox + исправить кодировку. Empty_ProxyNaive: обновлены `ANDROID-NEKO-DNS-FIX.txt`, `PHONE-*.txt` (45.144.28.49, Server=домен, api.ipify.org); `push_phone_neko_config.ps1` пишет UTF-8 BOM; пуш на Honor Download выполнен; `naiveproxy_client_and_ops.txt` A8–A14 синхронизированы.
